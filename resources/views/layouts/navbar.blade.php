...
<h5 class="fw-bold text-white">BACHELOR<span style="color:orange;"> HOUSING</span> <br>MANAGEMENT  <span style="color:green;"> WEBSITE</span></h5>
<div class="container py-1 px-5">
      ...
      <a class="fw-bold nav-link mx-2 text-white"  href="{{ route('dashboardAdmin') }}">Dashboard</a>
        @endif
        @if(Session::has('manager'))
       <a class="fw-bold nav-link mx-2 text-white"  href="{{ route('dashboardManager') }}">Dashboard</a>
        @endif
        <a class="fw-bold nav-link mx-2 text-white"  href="{{ route('contact') }}">Contact US</a>
